...
from database import db, User, Watch, PriceHistory, MAX_FREE_WATCHES, CGU_VERSION
...
def montre(watch_id):
    ...
    return render_template("montre.html", watch=w, conseil=conseil, history=history)
